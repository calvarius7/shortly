...
class ShortLinkDtoValidationTest {
    ...
    class ValidCases {
        ...
        void valid() {
            ShortLinkDto dto = new ShortLinkDto("https://example.org/ok", Instant.now().plusSeconds(60));
    ...
    class InvalidCases {
        ...
        void blankUrl() {
            ShortLinkDto dto = new ShortLinkDto("", Instant.now().plusSeconds(60));
            var violations = validator.validate(dto);
        ...
        void invalidUrl() {
            ShortLinkDto dto = new ShortLinkDto("not-a-url", Instant.now().plusSeconds(60));
            var violations = validator.validate(dto);
        ...
        void pastExpiry() {
            ShortLinkDto dto = new ShortLinkDto("https://example.org/ok", Instant.now().minusSeconds(5));
            var violations = validator.validate(dto);
